...
auto KrbServiceHandler::handle_request(bufferlist::iterator& indata, 
...
auto KrbServiceHandler::start_session(EntityName& name, 
                                      ...
                                      AuthCapsInfo& caps)
{
  ...
  gss_buffer_in.value  = reinterpret_cast<void*>(GSS_TARGET_DEFAULT_NAME.c_str());
  entity_name = name;

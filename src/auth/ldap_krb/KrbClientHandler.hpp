...
class KrbClientHandler : public AuthClientHandler 
{
  ...
  public:
    ...
    auto build_request(bufferlist&) const override;
    auto handle_response(int, bufferlist::iterator&) override;
    auto build_rotating_request(bufferlist&) const override { return false; }
    auto get_protocol() const override { return CEPH_AUTH_KRB5; }
    auto need_tickets() override { return false; }

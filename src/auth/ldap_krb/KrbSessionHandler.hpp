...
class KrbSessionHandler : public AuthSessionHandler
{
  public:
    ...
    auto no_security() { return true; }
    auto sign_message(Message* msg) { return 0; }
    auto check_message_signature(Message* msg) { return 0; }
    auto encrypt_message(Message* msg) { return 0; }
    auto decrypt_message(Message* msg) { return 0; }

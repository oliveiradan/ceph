...
static const std::string PROTO_SEP(std::to_string(COLON) +
                                   std::to_string(SLASH) +
                                   std::to_string(SLASH));
...
static const std::string MSG_FAILED_DNS_RESOLV("Failed to resolve host/DNS name: ");
...
namespace threading
{
    ...
    public:
        ...
        */
        ...
        /*  Lets wait until we have work, unless we queue_clear the queue, or it is destroyed.
    ...
    public:
        /*  Note that, std::thread::hardware_concurrency() returns the
            ...
            The value should be considered only a hint and if not well defined
            or not computable, it will return 0.
        ...
        */
        ...
        explicit ThreadPool(const std::uint32_t max_threads) :  m_is_it_done{false},
                                                                m_work_queue{},
                                                                m_threads{}
        {
          try {
        ...
        /*  We use std::future so this object can block/wait for the execution
            to terminate, before leaving the scope.
        */
        template <typename Type_>
        ...
        public:
            ...
            TaskFutureWrapper& operator= (const TaskFutureWrapper& rhs) = delete;
            TaskFutureWrapper(TaskFutureWrapper&& other) = default;
            TaskFutureWrapper& operator= (TaskFutureWrapper&& other) = default;
    ...
    private:
        ...
        public:
            ...
            //-- Assigments and move constructs/ops
        ...
        */
        ...
        /* We completely invalidate and joing all threads running.
        */
        void thread_destroy() {
          m_is_it_done = true;
